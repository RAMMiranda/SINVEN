...
insert into productos(producto,fecha_caducidad,cantidad,id_material,id_uso, detalle) values('Berenjena','2019-12-25',100,1,1, 'Medidas en unidades');
insert into Tipo_Movimientos(movimiento) values('Entrada'),('Salida');
insert into movimientos(id_producto,fecha,id_tipo,cantidad,detalle)values(1,'2019-10-10 10:30:00',1,120,'Nuevo Stock');
